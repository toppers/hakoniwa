...
- **[ROSCon JP 2023](https://roscon.jp/)** に、TOPPERSプロジェクトはブロンズスポンサーとして協賛します。
  - ROSCon JPは、ロボット開発プラットフォームであるROS（Robot Operating System）に関する開発者会議の日本版です。2023年9月26日(火)に開催されます。
  - 今回は、TOPPERSプロジェクトの機器展示出展を行います。TOPPERSプロジェクトにおいてROSコミュニティに貢献している内容として、箱庭によるROSアプリケーションの仮想シミュレーション環境や、TOPPERSカーネルを活用した組込みマイコン向けのROS 2ノード実行環境などを展示する予定です。
  - プログラムや参加申込み方法などの詳細は、[ROSCon JP 2023のWebページ](https://roscon.jp/)をご参照ください。
...
<!--
- **[RSJ2022（第40回日本ロボット学会学術講演会）](https://ac.rsj-web.org/2022/exhibition.html)** におけるTOPPERSプロジェクトの機器展示ブースにて、箱庭の開発成果物を紹介します。東京大学本郷キャンパス工学部2号館にて開催、機器展示の期間は2022年9月6日(火)-8日(木)となります。RSJ2022に参加される方は、ぜひTOPPERSプロジェクトのブースにお立ち寄りください。
-->
<!--
...
SWESTとは、大学の研究者や学生、企業の技術者や管理者、その他、組込みシステムに関わる全ての人達が、徹底的に議論できる場を提供することを主な目的とした合宿型のワークショップです。箱庭WGのメンバが企画・実施するセッションもありますので、ぜひご参加ください。
  ...
  コーディネータ：高瀬 英希（東京大学）
-->
- 箱庭WG主査の森崇を代表社員として、2023年8月1日に[合同会社箱庭ラボ](https://hakoniwa-lab.net/)を設立しました。
