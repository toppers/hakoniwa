...
**[SI2024(第25回計測自動制御学会システムインテグレーション部門講演会)](https://sice-si.org/si2024/)** が2024年12月18日(水)-20日(金)に開催され、箱庭WGのメンバが発表を行いました。

#### 宇宙ドメインにおけるマルチシステムを横断する箱庭技術を活用したシミュレーション環境の提案

- [発表資料 (PDFファイル)
{{< image src="doc/SI2024.png" border="1" width="400" >}}
](/hakoniwa/doc/SI2024.pdf)
- [ポスター (PDFファイル)
{{< image src="doc/SI2024-poster.png" border="1" width="400" >}}
](/hakoniwa/doc/SI2024-poster.pdf)
